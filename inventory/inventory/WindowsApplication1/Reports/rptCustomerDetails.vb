...
Public Class rptCustomerDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptCustomerDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerDetails = New rptCustomerDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
