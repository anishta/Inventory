...
Public Class rptrDateWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptrDateWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptrDateWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptrDateWise = New rptrDateWise
        rpt.Site = Me.Site
        Return rpt
    End Function
