...
Public Class rptDateWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptDateWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDateWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDateWise = New rptDateWise
        rpt.Site = Me.Site
        Return rpt
    End Function
