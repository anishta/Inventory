...
Public Class rptProductDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptProductDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductDetails = New rptProductDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
