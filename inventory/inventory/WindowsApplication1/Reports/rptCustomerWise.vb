...
Public Class rptCustomerWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptCustomerWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Supplier_Name() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCustomerWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerWise = New rptCustomerWise
        rpt.Site = Me.Site
        Return rpt
    End Function
